...
$GLOBALS['TL_DCA']['tl_content']['palettes']['flickity_slider_image'] = '{type_legend},type,title;{source_legend},multiSRC,orderSRC;{config_legend},cellWidth,cellHeight,autoSlide;{protected_legend:hide},protected;{expert_legend:hide},guest,cssID,space;{invisible_legend:hide},invisible,start,stop';
$GLOBALS['TL_DCA']['tl_content']['fields']['autoSlide'] = array
(
    'label'                   => &$GLOBALS['TL_LANG']['tl_content']['autoSlide'],
    'exclude'                 => true,
    'search'                  => true,
    'inputType'               => 'checkbox',
    'eval'                    => array('include', 'tl_class' => 'w50 m12'),
...
$GLOBALS['TL_DCA']['tl_content']['fields']['cellWidth'] = array
(
    'label'                   => &$GLOBALS['TL_LANG']['tl_content']['cellWidth'],
    'inputType'               => 'inputUnit',
    'options'                 => $GLOBALS['TL_CSS_UNITS'],
...
$GLOBALS['TL_DCA']['tl_content']['fields']['cellHeight'] = array
(
    'label'                   => &$GLOBALS['TL_LANG']['tl_content']['cellHeight'],
    'inputType'               => 'inputUnit',
    'options'                 => $GLOBALS['TL_CSS_UNITS'],
